...
#'   \item \code{compactness}: Compactness index \eqn{4 \pi \times \mathrm{area} / \mathrm{perimeter}^2}.
#' }
...
#' Example Workflow for Compactness and Area Visualization
#'
#' Demonstrates how to read spatial data, calculate metrics, and visualize.
#'
#' @name compactness_area_workflow
#' @examples
#' \dontrun{
